      ...
      <div className="max-w-(--spacing-container-max) mx-auto px-6 md:px-margin-desktop">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 pb-10 mb-12 border-b border-pure-white/5 text-center md:text-left">
          ...
          <form
            ...
            noValidate
            className={`flex items-center bg-pure-white/5 rounded-full p-1 border transition-all duration-300 w-full max-w-sm ${status === 'error'
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <ul className="space-y-2.5 text-xs">
              {[
                ...
                { label: 'Kate Clinic', to: '/kate-clinic' },
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-6 text-xs font-light text-pure-white/40">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex gap-4 items-center">
              ...
              <a href="https://www.tiktok.com/@katondatalemwaministries?_r=1&_t=ZS-9A0INxdtPdd" aria-label="Tiktok" className="hover:text-vibrant-green transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.04-.1z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/katondatalemwaministries?utm_source=qr&stkn=M3A4cjVxZmo2c3dr" aria-label="Instagram" className="hover:text-vibrant-green transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              <a href="https://youtube.com/@katondatalemwaministriesuganda?si=VJBx5YbnSEV8-gTH" aria-label="YouTube" className="hover:text-vibrant-green transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
