          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <ul className="space-y-2.5 text-xs">
              {[
                ...
                { label: 'Neighbourhood Mothers', to: '#' },
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-6 text-xs font-light text-pure-white/40">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex gap-4 items-center">
              <a href="#" aria-label="Facebook" className="hover:text-vibrant-green transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                </svg>
              </a>
              <a href="#" aria-label="X (Twitter)" className="hover:text-vibrant-green transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="hover:text-vibrant-green transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              <a href="#" aria-label="YouTube" className="hover:text-vibrant-green transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
